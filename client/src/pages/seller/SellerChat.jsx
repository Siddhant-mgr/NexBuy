...
import { FaPaperPlane, FaUser, FaMapMarkerAlt } from 'react-icons/fa';
  ...
  useEffect(() => {
    ...
    const loadChats = async () => {
      ...
      try {
        ...
        const nextChats = Array.from(customerMap.values()).map((customer) => ({
          id: customer._id,
          customerName: customer.name || customer.email || 'Customer',
          distance: null,
          avatarUrl: customer.avatarUrl || '',
          roomId: `chat:store:${storeId}:customer:${customer._id}`
        }));
            ...
            {chats.map((chat) => (
              ...
              >
                <div className="chat-item-avatar">
                  {chat.avatarUrl ? (
                    <img src={chat.avatarUrl} alt={chat.customerName} />
                  ) : (
                    <FaUser />
                  )}
                </div>
