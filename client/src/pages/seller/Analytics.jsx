      ...
      <div className="analytics-stats">
        <div className="stat-card-large">
          ...
          <div className="stat-info-large">
            <h3>NRS {Number(stats.totalSales || 0).toLocaleString()}</h3>
            <p>Total Sales</p>
        ...
        <div className="stat-card-large">
          ...
          <div className="stat-info-large">
            <h3>NRS {Number(stats.averageOrderValue || 0).toFixed(2)}</h3>
                ...
                {recentOrders.length === 0 ? (
                  ...
                  recentOrders.map((order) => (
                    <tr key={order.id}>
                      ...
                      <td>NRS {Number(order.totalAmount || 0).toFixed(2)}</td>
              ...
              topProducts.map((product, index) => (
                <div key={product.productId} className="top-product-item">
                  ...
                  <div className="product-details">
                    <h4>{product.name}</h4>
                    <p>{product.sales} sales • NRS {Number(product.revenue || 0).toFixed(2)} revenue</p>
                  </div>
                </div>
              ))
            )}
